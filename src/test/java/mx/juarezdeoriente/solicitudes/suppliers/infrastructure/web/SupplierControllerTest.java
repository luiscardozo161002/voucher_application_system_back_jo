...
import mx.juarezdeoriente.solicitudes.shared.infrastructure.web.PageableDefaults;
...
class SupplierControllerTest {
    ...
    void crear_proveedor_valido_retorna_201() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/suppliers")
                        ...
                        .content(mapper.writeValueAsString(
                                new SupplierRequest("PROV-TEST", "Proveedor Test", "555-0000"))))
    ...
    void crear_proveedor_duplicado_retorna_409() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/suppliers")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(mapper.writeValueAsString(
                                new SupplierRequest("PROV-001", "Nombre", null))))
    ...
    void crear_proveedor_sin_autenticacion_retorna_401() throws Exception {
        mockMvc.perform(post("/api/v1/suppliers")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(mapper.writeValueAsString(
                                new SupplierRequest("PROV-NEW", "Nuevo", null))))
